...
namespace Layout.Systems
{
    ...
    public sealed class GuideRenderer : IRenderer
    {
            ...
            PlaneAxis shapePlaneAxis = PlaneAxis.Y)
        {
            ...
            int slabSide = 0;
            if (isSurface) voxels = FlattenToPlaneLayer(voxels, settings.Plane, renderScale, out slabSide);
                                                        ...
                                                        out int slabSide)
        {
            ...
            {
                int solidsPos = CountSolidProbes(voxels, axis, layerPos, scale);
                int solidsNeg = CountSolidProbes(voxels, axis, layerNeg, scale);
        ...
        private int CountSolidProbes(List<VoxelPosition> voxels, PlaneAxis axis, int layer, int scale)
        {
        ...
        private void RebuildGuide(GuideData guide)
        {
            ...
            int slabSide = 0;
            if (isSurface) voxels = FlattenToPlaneLayer(voxels, guide.Plane, renderScale, out slabSide);
